...
description: "High signal-to-noise communication style for AI assistants. Load when you want responses that are detailed but pithy — direct, candid, and free of filler. Modeled on senior colleague communication in a high-trust environment."
trigger_phrases:
  - pithy communication
  - communication style
  - signal to noise
